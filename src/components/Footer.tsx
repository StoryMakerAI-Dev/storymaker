        ...
        <div className={`flex flex-col ${isMobile ? 'gap-3' : 'md:flex-row gap-4'} justify-between items-center`}>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1 text-xs md:text-sm text-gray-500">
              <span className="text-center mx-[5px] font-bold">⚠️Disclaimer: Story Maker AI is designed to inspire creativity and assist in generating stories for personal enjoyment, creative projects, and entertainment purposes. It is not intended to be used for academic or school assignments. Using this tool for schoolwork may violate your institution’s policies and could result in disciplinary action. Please use the tool responsibly and adhere to your school’s guidelines.⚠️  Made by Jacob and with 💗</span>
